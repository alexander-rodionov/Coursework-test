...
public:
                       ...
                       HTTPServerResponse &response) override
    {
        ...
        try
        {
            if (form.has("user_id") && (request.getMethod() == Poco::Net::HTTPRequest::HTTP_GET) and hasSubstr(request.getURI(), "/get"))
            {
            ...
            } else if (((request.getMethod() == Poco::Net::HTTPRequest::HTTP_POST) and hasSubstr(request.getURI(), "/post")))
            {
